...
@section('container')
    ...
    <div class="card mb-3">
        ...
        @else
        <img src="https://source.unsplash.com/1000x250?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
        @endif
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <a href="/blog/{{ $post->slug }}" class="text-decoration-none" class="btn btn-primary">Read More</a>
                        </div>
                    </div>
                </div>
            @endforeach
